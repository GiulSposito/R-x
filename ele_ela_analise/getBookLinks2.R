...
n <- "2112"
url.books.index <- "http://www.dominiopublico.gov.br/pesquisa/ResultadoPesquisaObraForm.do?first=500&skip=0&ds_titulo=&co_autor=&no_autor=&co_categoria=2&pagina=2&select_action=Submit&co_midia=2&co_obra=&co_idioma=1&colunaOrdenar=null&ordem=null"
